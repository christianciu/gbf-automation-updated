...
const StartHelper = () => {
    ...
    const handleReady = () => {
        ...
        if (!doesNotNeedSummons.includes(farmingMode) && farmingMode !== "Generic" && farmingMode !== "GenericV2" && farmingMode !== "Scheduler" && farmingMode !== "") {
            ...
            bsc.setReadyStatus((farmingMode === "Generic" || farmingMode === "GenericV2" || farmingMode === "Scheduler") && bsc.settings.game.item !== "" && bsc.settings.game.summons.length !== 0)
        }
    }
